...
def calculate_annual_amount(amount: float, frequency: str) -> float:
...
# Liability utilities
def get_liability_type_display(liability_type: str) -> str:
...
def calculate_total_interest(balance: float, monthly_payment: float, interest_rate: float, liability_type: str) -> float:
...
def get_impact_description(event_type: str, amount: float) -> str:
...
def get_risk_tolerance_display(risk_tolerance: str) -> str:
